...
const quickActions = [
  {
    ...
    description: 'Enroll in a new program',
    icon: <Plus size={20} />,
    href: '/student-portal/enrollment/new',
  },
  {
    title: 'Make Payment',
  ...
  },
  {
    ...
    href: '/student-portal/receipts',
  },
  {
    title: 'Fee Statement',
    description: 'Download fee statement',
    icon: <Download size={20} />,
    href: '/student-portal/statements',
  },
];

export function StudentPortalQuickActions() {
  return (
